    ...
    <div>
      <div className="gameMenuContainer">
        ...
        {numStartNodes > 2 ? (
          <div>
            <div
              className={`contenderChoice ${
                selectedDiv === "contenderChoice3" ? "selectedChoice" : ""
        ...
        {numStartNodes > 3 ? (
          <div>
            <div
              className={`contenderChoice ${
                selectedDiv === "contenderChoice4" ? "selectedChoice" : ""
      ...
      <div className="gameMenuButtonContainer">
        <div className="gameMenuLeftSideItems">
          <button
            className={
              visIsOngoing || visIsFinished
                ? "cursorNotAllowed gameMenuButton justVisualizeButton"
                : "gameMenuButton justVisualizeButton"
            }
            onClick={() =>
              !visIsOngoing &&
              !visIsFinished &&
          ...
          <button
            className={
              visIsOngoing
                ? "cursorNotAllowed gameMenuButton newMapButton"
                : "gameMenuButton newMapButton"
            }
        ...
        <div className="gameMenuRightSideItems">
          ...
          <button
            className={
              visIsOngoing
                ? "cursorNotAllowed gameMenuButton settingsMenuButton"
                : "gameMenuButton settingsMenuButton"
            }
